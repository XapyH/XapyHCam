...
def AmerikaBirlesikDevletleri():
    ...
    print("{}  '--------------------------'  ").format(r,w)
    print("{}       [ {}Sayfa Listesi : {} {}]").format(r,w,rfindpage,r)
    run()
    
def run():
    try:
        page = input("\033[1;31m       [ \033[1;37mSayfa \033[1;31m]\033[1;37m> ")
        ...
        print ""
        print r+"XapyH İyi Seyirler Diler :)"+w
